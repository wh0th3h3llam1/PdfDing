...
urlpatterns = [
    ...
    path('shared/download/<shared_id>', share_views.Download.as_view(), name='download_shared'),
    path('shared/edit/<shared_id>/<field_name>', share_views.Edit.as_view(), name='edit_shared'),
    path('shared/get/<shared_id>', share_views.Serve.as_view(), name='serve_shared'),
